...
Gating reward: if R_fmt = 0 the sample is essentially unusable downstream
(judge/solver cannot even see a figure), so per-sample weighting should
keep this term non-trivial.
"""
...
from nemo_rl.hackaton.render.svg_render import RenderResult, render
